...
第一行的 14.0 和 0.12 都以 THz 为单位，分别控制谱函数覆盖范围和频率展宽；它们不是 μ*。最后的 0.10 才进入 Tc 公式。八个 q 点的星权重合计 64，且每个文件包含三个模式和十组电子展宽。

这份 Al 数据的最高直接计算频率为 9.936574 THz，14 THz 覆盖了谱峰及 Gaussian 尾部。更换材料时，不能直接照抄上限。若高频谱权重落在输出范围外，ω_log 和谱函数积分会失真；此时一个有限的 Tc 数字也不说明输入完整。
...
| 电子展宽 / Ry | λ | ω_log / K | 公式 Tc / K，μ*=0.10 |
|---:|---:|---:|---:|
| 0.005 | 0.430378 | 355.877 | 2.212103 |
| 0.010 | 0.371061 | 344.606 | 0.915531 |
| 0.015 | 0.370295 | 343.420 | 0.900166 |
| 0.020 | 0.374486 | 343.741 | 0.969046 |
| 0.025 | 0.374613 | 343.537 | 0.970575 |
| 0.030 | 0.373773 | 342.831 | 0.954739 |
| 0.035 | 0.373581 | 342.006 | 0.949300 |
| 0.040 | 0.374086 | 341.243 | 0.955437 |
| 0.045 | 0.375022 | 340.631 | 0.969102 |
| 0.050 | 0.376041 | 340.145 | 0.984595 |
