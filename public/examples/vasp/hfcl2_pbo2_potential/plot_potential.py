...
for n,w in enumerate(s['windows']):
    ax.axvspan(w['lo_A'],w['hi_A'],color=['#1b9e77','#d95f02'][n%2],alpha=.14)
    ax.hlines(w['mean_eV'],w['lo_A'],w['hi_A'],color=['#1b9e77','#d95f02'][n%2],lw=2,label='Window %d: %.4f eV'%(n+1,w['mean_eV']))
