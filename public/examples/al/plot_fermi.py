...
for n,style in [(24,"--"),(32,"-")]:
    ...
    for band,color in [(1,"#286b95"),(2,"#d46543")]:
...
ax.legend(handles=[Line2D([0],[0],color="#286b95",label="band 2"),Line2D([0],[0],color="#d46543",label="band 3"),Line2D([0],[0],color="0.3",ls="--",label="24³ mesh"),Line2D([0],[0],color="0.3",label="32³ mesh")],frameon=False,fontsize=9)
